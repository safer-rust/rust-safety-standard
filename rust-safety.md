...
Note that under the (Weak) Struct-level Soundness Criterion, structs and their associated functions cannot rely on visibility restrictions to maintain soundness, since they may be accessed by other code within the same module.
